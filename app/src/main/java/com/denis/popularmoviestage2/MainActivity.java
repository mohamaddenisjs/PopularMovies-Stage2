...
import com.denis.popularmoviestage2.adapter.MovieAdapter;
...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener, MovieAdapter.GridItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            if (mSharedPreferences.getString(getString(R.string.sort_by), getString(R.string.most_popular)).equals(getString(R.string.favorite))) {
                showFetchingDataUI();
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.i_favorite:
                showToast(getString(R.string.favorite));
                editor.putString(getString(R.string.sort_by), getString(R.string.favorite));
                editor.commit();
                showFetchingDataUI();
        ...
        public Loader<List<Result>> onCreateLoader(int id, final Bundle args) {
            return new AsyncTaskLoader<List<Result>>(MainActivity.this) {
                ...
                public List<Result> loadInBackground() {
                    ...
                    String finalUrl = URLContent.getInitialUrl(MainActivity.this, choice);
    ...
    public void onClick(Result object) {
        if (mTwoPane) {
            ...
            bundle.putSerializable(DetailFragment.MOVIE_ARG_KEY, object);
            DetailFragment detailFragment = new DetailFragment();
            detailFragment.setArguments(bundle);
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.movie_detail_container, detailFragment, DETAIL_FRAGMENT_TAG).commit();
        } else {
            Intent detailIntent = new Intent(MainActivity.this, DetailActivity.class);
            detailIntent.putExtra(DetailFragment.MOVIE_ARG_KEY, object);
