...
import com.denis.popularmoviestage2.adapter.ReviewAdapter;
import com.denis.popularmoviestage2.adapter.TrailerAdapter;
import com.denis.popularmoviestage2.data.MovieContract;
import com.denis.popularmoviestage2.databinding.FragmentDetailBinding;
...
import com.denis.popularmoviestage2.util.ImageUtils;
import com.denis.popularmoviestage2.util.JSONUtils;
import com.denis.popularmoviestage2.util.NetworkUtils;
import com.denis.popularmoviestage2.util.URLContent;
import com.squareup.picasso.Picasso;

import java.util.List;

import static com.denis.popularmoviestage2.MainActivity.mProjection;
...
public class DetailFragment extends Fragment implements TrailerAdapter.ListItemClickListener {
    ...
    private FragmentDetailBinding mFragmentMovieDetailBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFragmentMovieDetailBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_detail, container, false);
...
/*    private void hookUpMovieCastUI() {
    ...
    private class MovieCallback implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
            if (data.moveToFirst()) {
                mFragmentMovieDetailBinding.movieDetail.ivFavorite.setImageResource(R.drawable.fav_icon);
                mMovie.setFavourite(true);
            } else {
                mFragmentMovieDetailBinding.movieDetail.ivFavorite.setImageResource(R.drawable.fav_icon);
                mMovie.setFavourite(false);
            }
            mFragmentMovieDetailBinding.movieDetail.ivFavorite.setOnClickListener(new View.OnClickListener() {
                @Override
